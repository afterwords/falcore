...
static const blackboxDeltaFieldDefinition_t blackboxMainFields[] = {
    ...
    /* rcCommands are encoded together as a group in P-frames: */
    {"rcStickCmd",  0, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),      .Pencode = ENCODING(TAG8_4S16), CONDITION(ALWAYS)},
    {"rcStickCmd",  1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),      .Pencode = ENCODING(TAG8_4S16), CONDITION(ALWAYS)},
    {"rcStickCmd",  2, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),      .Pencode = ENCODING(TAG8_4S16), CONDITION(ALWAYS)},
    /* Throttle is always in the range [minthrottle..maxthrottle]: */
    {"rcStickCmd",  3, UNSIGNED, .Ipredict = PREDICT(MINTHROTTLE), .Iencode = ENCODING(UNSIGNED_VB), .Ppredict = PREDICT(PREVIOUS),  .Pencode = ENCODING(TAG8_4S16), CONDITION(ALWAYS)},
    ...
    /* Debug variables */
    {"debug",      0, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(TAG8_8SVB), CONDITION(ALWAYS)},
    {"debug",      1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(TAG8_8SVB), CONDITION(ALWAYS)},
    {"debug",      2, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(TAG8_8SVB), CONDITION(ALWAYS)},
    {"debug",      3, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(TAG8_8SVB), CONDITION(ALWAYS)},

    /* Altitude hold data */
    {"estAccZ",     -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"estAglAlt",   -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"estAglVel",   -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},

    {"tgtAHAlt",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"tgtAHVel",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},

    {"altPID_P",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"altPID_I",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"altPID_D",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    //{"altPID_F",    -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},

    {"altQual",     -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"sonarQual",   -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"baroOffset",  -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    //{"altHoldCorr", -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},

    {"dirModeVel",  -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"snlFwdVel",   -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"snlRightVel", -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    //{"dirTgtRoll",  -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    //{"dirTgtYawRt", -1, SIGNED,   .Ipredict = PREDICT(0),       .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},

    {"crashDetectLevel", -1, SIGNED, .Ipredict = PREDICT(0),    .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"snlState",    -1, SIGNED, .Ipredict = PREDICT(0),         .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    {"takeoffState",-1, SIGNED, .Ipredict = PREDICT(0),         .Iencode = ENCODING(SIGNED_VB),   .Ppredict = PREDICT(PREVIOUS),     .Pencode = ENCODING(SIGNED_VB), CONDITION(ALWAYS)},
    };
...
typedef struct blackboxMainState_s {
    ...
    int16_t targetAltHoldAlt;
    int16_t targetAltHoldVel;
    ...
    //int16_t dirTargetRollAngle;
    //int16_t dirTargetYawRate;

    int16_t crashDetectLevel;
    int16_t snlState;
    int16_t takeoffState;
...
static void writeIntraframe(void)
{
    ...
    // Write roll, pitch and yaw first:
    blackboxWriteSigned16VBArray(blackboxCurrent->rcStickCommand, 3);

    /*
     * Write the throttle separately from the rest of the RC data so we can apply a predictor to it.
     * Throttle lies in range [minthrottle..maxthrottle]:
     */
    blackboxWriteUnsignedVB(blackboxCurrent->rcStickCommand[THROTTLE] - masterConfig.escAndServoConfig.minthrottle);
    ...
    // AMIMON: internals
    blackboxWriteSignedVB(blackboxCurrent->estAccZ);
    blackboxWriteSignedVB(blackboxCurrent->estAglAlt);
    blackboxWriteSignedVB(blackboxCurrent->estAglVel);

    blackboxWriteSignedVB(blackboxCurrent->targetAltHoldAlt);
    blackboxWriteSignedVB(blackboxCurrent->targetAltHoldVel);

    blackboxWriteSignedVB(blackboxCurrent->altPidP);
    blackboxWriteSignedVB(blackboxCurrent->altPidI);
    blackboxWriteSignedVB(blackboxCurrent->altPidD);
    //blackboxWriteSignedVB(blackboxCurrent->altPidF);

    blackboxWriteSignedVB(blackboxCurrent->estAltQuality);
    blackboxWriteSignedVB(blackboxCurrent->sonarConsistency);
    blackboxWriteSignedVB(blackboxCurrent->estBaroOffset);
    //blackboxWriteSignedVB(blackboxCurrent->altHoldAdjustment);

    blackboxWriteSignedVB(blackboxCurrent->logDirModeVel);
    blackboxWriteSignedVB(blackboxCurrent->logSnlFwdVel);
	blackboxWriteSignedVB(blackboxCurrent->logSnlRightVel);
    //blackboxWriteSignedVB(blackboxCurrent->dirTargetRollAngle);
    //blackboxWriteSignedVB(blackboxCurrent->dirTargetYawRate);

    blackboxWriteSignedVB(blackboxCurrent->crashDetectLevel);
    blackboxWriteSignedVB(blackboxCurrent->snlState);
    blackboxWriteSignedVB(blackboxCurrent->takeoffState);
...
static void writeInterframe(void)
{
    ...
    for (x = 0; x < 4; x++) {
        deltas[x] = blackboxCurrent->rcStickCommand[x] - blackboxLast->rcStickCommand[x];
    }
    ...
    // Debug variables
    for (x = 0; x < 4; x++) {
        deltas[x] = blackboxCurrent->debug[x] - blackboxLast->debug[x];
    }
    blackboxWriteTag8_8SVB(deltas, DEBUG16_VALUE_COUNT);

    // AMIMON: althold internals
    blackboxWriteSignedVB(blackboxCurrent->estAccZ - blackboxLast->estAccZ);
    blackboxWriteSignedVB(blackboxCurrent->estAglAlt - blackboxLast->estAglAlt);
    blackboxWriteSignedVB(blackboxCurrent->estAglVel - blackboxLast->estAglVel);

    blackboxWriteSignedVB(blackboxCurrent->targetAltHoldAlt - blackboxLast->targetAltHoldAlt);
    blackboxWriteSignedVB(blackboxCurrent->targetAltHoldVel - blackboxLast->targetAltHoldVel);

    blackboxWriteSignedVB(blackboxCurrent->altPidP - blackboxLast->altPidP);
    blackboxWriteSignedVB(blackboxCurrent->altPidI - blackboxLast->altPidI);
    blackboxWriteSignedVB(blackboxCurrent->altPidD - blackboxLast->altPidD);
    //blackboxWriteSignedVB(blackboxCurrent->altPidF - blackboxLast->altPidF);

    blackboxWriteSignedVB(blackboxCurrent->estAltQuality - blackboxLast->estAltQuality);
    blackboxWriteSignedVB(blackboxCurrent->sonarConsistency - blackboxLast->sonarConsistency);
    blackboxWriteSignedVB(blackboxCurrent->estBaroOffset - blackboxLast->estBaroOffset);
    //blackboxWriteSignedVB(blackboxCurrent->altHoldAdjustment - blackboxLast->altHoldAdjustment);

    blackboxWriteSignedVB(blackboxCurrent->logDirModeVel - blackboxLast->logDirModeVel);
    blackboxWriteSignedVB(blackboxCurrent->logSnlFwdVel - blackboxLast->logSnlFwdVel);
	blackboxWriteSignedVB(blackboxCurrent->logSnlRightVel - blackboxLast->logSnlRightVel);
    //blackboxWriteSignedVB(blackboxCurrent->dirTargetRollAngle - blackboxLast->dirTargetRollAngle);
    //blackboxWriteSignedVB(blackboxCurrent->dirTargetYawRate - blackboxLast->dirTargetYawRate);

    blackboxWriteSignedVB(blackboxCurrent->crashDetectLevel - blackboxLast->crashDetectLevel);
    blackboxWriteSignedVB(blackboxCurrent->snlState - blackboxLast->snlState);
    blackboxWriteSignedVB(blackboxCurrent->takeoffState - blackboxLast->takeoffState);
...
static void loadMainState(void)
{
    ...
    for (i = 0; i < 4; i++) {
        blackboxCurrent->rcStickCommand[i] = rcStickCommand[i];
    }
    ...
    blackboxCurrent->estAccZ = g_altitudeHoldLog.altHoldAccZ;
    blackboxCurrent->estAglAlt = g_altitudeHoldLog.logEstAglAlt;
    blackboxCurrent->estAglVel = g_altitudeHoldLog.logEstAglVel;

    blackboxCurrent->targetAltHoldVel = g_altitudeHoldLog.logTargetVel;
    blackboxCurrent->targetAltHoldAlt = g_altitudeHoldLog.logTargetAlt;

    blackboxCurrent->altPidP = g_altitudeHoldLog.logPidP;
    blackboxCurrent->altPidI = g_altitudeHoldLog.logPidI;
    blackboxCurrent->altPidD = g_altitudeHoldLog.logPidD;
    //blackboxCurrent->altPidF = g_altitudeHoldLog.logPidF;

    blackboxCurrent->estAltQuality = g_altitudeHoldLog.estAltQuality;
    blackboxCurrent->sonarConsistency = g_altitudeHoldLog.sonarConsistency;
    blackboxCurrent->estBaroOffset = g_altitudeHoldLog.estBaroOffset;
    //blackboxCurrent->altHoldAdjustment = g_altitudeHoldLog.altHoldAdjustment;

    blackboxCurrent->logDirModeVel = g_directionModeLogData.logDirModeVel;
    blackboxCurrent->logSnlFwdVel = g_directionModeLogData.logSnlFwdVel;
	blackboxCurrent->logSnlRightVel = g_directionModeLogData.logSnlRightVel;
    //blackboxCurrent->dirTargetRollAngle = g_directionModeLogData.targetRollAngle;
    //blackboxCurrent->dirTargetYawRate = g_directionModeLogData.targetYawRate;

    blackboxCurrent->crashDetectLevel = g_logCrashDetectLevel;
    blackboxCurrent->snlState = g_logSnlState;
    blackboxCurrent->takeoffState = g_altitudeHoldLog.logTakeoffState;
