...
#define SEND_ALTITUDE_HOLD_DEBUG_TELEMETRY
...
{
#ifndef SEND_ALTITUDE_HOLD_DEBUG_TELEMETRY
    int i;
    for (i = 0; i < 3; i++) {
    ...
    serialize16(g_altitudeHoldLog.debugTelemetyValues[2]);

    sendDataHead(ID_ACC_Y);
    serialize16(g_altitudeHoldLog.debugTelemetyValues[3]);
    //serialize16(((float)accADC[Y] / acc_1G) * 1000);

    sendDataHead(ID_ACC_Z);
    serialize16(((float)accADC[Z] / acc_1G) * 1000);
#endif
}
...
#ifdef SEND_ALTITUDE_HOLD_DEBUG_TELEMETRY
static void sendAltitudeHoldDebugData(void)
{
    sendDataHead(ID_TEMPRATURE1);
    //g_altitudeHoldLog.debugTelemetyValues[0] = 11;
    serialize16(g_altitudeHoldLog.debugTelemetyValues[0]);
    //g_altitudeHoldLog.debugTelemetyValues[1] = 22;
    sendDataHead(ID_TEMPRATURE2);
    serialize16(g_altitudeHoldLog.debugTelemetyValues[1]);
}
#endif
