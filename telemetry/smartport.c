    ...
    while (smartPortHasRequest) {
        ...
        switch(id) {
            ...
            case FSSP_DATAID_VARIO      :
                if (sensors(SENSOR_BARO)) {
                    smartPortSendPackage(id, altitudeHoldGetEstimatedClimbRate()); // unknown given unit but requested in 100 = 1m/s
                    smartPortHasRequest = 0;
                }
                break;
            ...
            case FSSP_DATAID_ACCX       :
                ...
                smartPortHasRequest = 0;
#else
                smartPortSendPackage(id, g_altitudeHoldLog.debugTelemetyValues[2]);
                smartPortHasRequest = 0;
#endif
                break;
            case FSSP_DATAID_ACCY       :
                ...
                smartPortHasRequest = 0;
#else
                smartPortSendPackage(id, g_altitudeHoldLog.debugTelemetyValues[3]);
                smartPortHasRequest = 0;
#endif
                break;
            ...
            case FSSP_DATAID_T1         :
                ...
                if (FLIGHT_MODE(HEADFREE_MODE))
                    tmpi += 4000;
#else
                tmpi = g_altitudeHoldLog.debugTelemetyValues[0];
#endif
...
#else
                smartPortSendPackage(id, g_altitudeHoldLog.debugTelemetyValues[1]);
                smartPortHasRequest = 0;
#endif
                break;
#ifdef GPS
