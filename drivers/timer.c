...
const timerHardware_t timerHardware[USABLE_TIMER_CHANNEL_COUNT] = {
    // MOTOR outputs
    { TIM8,  GPIOC, Pin_6,  TIM_Channel_1, TIM8_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource6,  GPIO_AF_4}, // PWM1 - PC6 - TIM8_CH1
    { TIM8,  GPIOC, Pin_7,  TIM_Channel_2, TIM8_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource7,  GPIO_AF_4}, // PWM2 - PC7 - TIM8_CH2
    { TIM8,  GPIOC, Pin_8,  TIM_Channel_3, TIM8_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource8,  GPIO_AF_4}, // PWM3 - PC8 - TIM8_CH3
    { TIM8,  GPIOC, Pin_9,  TIM_Channel_4, TIM8_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource9,  GPIO_AF_4}, // PWM4 - PC9 - TIM8_CH4

    // Additional servo outputs
    { TIM3,  GPIOA, Pin_4,  TIM_Channel_2, TIM3_IRQn,               0, Mode_AF_PP, GPIO_PinSource4,  GPIO_AF_2}, // PWM5 - PA4  - TIM3_CH2
    { TIM3,  GPIOB, Pin_1,  TIM_Channel_4, TIM3_IRQn,               0, Mode_AF_PP, GPIO_PinSource1,  GPIO_AF_2}, // PWM6 - PB1  - TIM3_CH4

    // PPM PORT - Also USART2 RX (AF5)
    { TIM2,  GPIOA, Pin_3,  TIM_Channel_4, TIM2_IRQn,               0, Mode_AF_PP, GPIO_PinSource3,  GPIO_AF_1}, // PPM - PA3  - TIM2_CH4

    // LED_STRIP
    { TIM1,  GPIOA, Pin_8,  TIM_Channel_1, TIM1_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource8,  GPIO_AF_6},  // GPIO_TIMER / LED_STRIP

    // PWM_BUZZER
    { TIM16, GPIOB, Pin_4,  TIM_Channel_1, TIM1_CC_IRQn,            1, Mode_AF_PP, GPIO_PinSource4,  GPIO_AF_6},  // BUZZER - PB4 - TIM16_CH1N
};
