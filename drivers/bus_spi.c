...
#ifdef STM32F303xC
static void spiPinInit(GPIO_TypeDef* gpio, uint16_t pin, GPIOOType_TypeDef otype, uint16_t pinSource, uint8_t pinAF)
{
    GPIO_InitTypeDef GPIO_InitStructure;

    GPIO_PinAFConfig(gpio, pinSource, pinAF);
...
void initSpi1(void)
{
    ...
    spiPinInit(SPI1_GPIO, SPI1_SCK_PIN, GPIO_OType_PP, SPI1_SCK_PIN_SOURCE, GPIO_AF_5);
    spiPinInit(SPI1_GPIO, SPI1_MISO_PIN, GPIO_OType_PP, SPI1_MISO_PIN_SOURCE, GPIO_AF_5);

#ifdef SPI1_MOSI_GPIO
    RCC_AHBPeriphClockCmd(SPI1_MOSI_GPIO_PERIPHERAL, ENABLE);
    spiPinInit(SPI1_MOSI_GPIO, SPI1_MOSI_PIN, GPIO_OType_PP, SPI1_MOSI_PIN_SOURCE, GPIO_AF_5);
#else
    spiPinInit(SPI1_GPIO, SPI1_MOSI_PIN, GPIO_OType_PP, SPI1_MOSI_PIN_SOURCE, GPIO_AF_5);
#endif

#ifdef SPI1_NSS_PIN_SOURCE
    spiPinInit(SPI1_GPIO, SPI1_NSS_PIN, GPIO_OType_PP, SPI1_NSS_PIN_SOURCE, GPIO_AF_5);
#endif
#endif
...
void initSpi2(void)
{
    ...
    spiPinInit(SPI2_GPIO, SPI2_SCK_PIN, GPIO_OType_PP, SPI2_SCK_PIN_SOURCE, GPIO_AF_5);
    spiPinInit(SPI2_GPIO, SPI2_MISO_PIN, GPIO_OType_PP, SPI2_MISO_PIN_SOURCE, GPIO_AF_5);

#ifdef SPI2_MOSI_GPIO
    RCC_AHBPeriphClockCmd(SPI2_MOSI_GPIO_PERIPHERAL, ENABLE);
    spiPinInit(SPI2_MOSI_GPIO, SPI2_MOSI_PIN, GPIO_OType_PP, SPI2_MOSI_PIN_SOURCE, GPIO_AF_5);
#else
    spiPinInit(SPI2_GPIO, SPI2_MOSI_PIN, GPIO_OType_PP, SPI2_MOSI_PIN_SOURCE, GPIO_AF_5);
#endif

#ifdef SPI2_NSS_PIN_SOURCE
    spiPinInit(SPI2_GPIO, SPI2_NSS_PIN, GPIO_OType_PP, SPI2_NSS_PIN_SOURCE, GPIO_AF_5);
#endif
#endif
