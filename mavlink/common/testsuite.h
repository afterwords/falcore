...
static void mavlink_test_prosight_osd(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PROSIGHT_OSD >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_prosight_osd_t packet_in = {
		17235,17339,17,84,151
    };
	mavlink_prosight_osd_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.altitude = packet_in.altitude;
        packet1.msg_id = packet_in.msg_id;
        packet1.flags = packet_in.flags;
        packet1.flight_mode = packet_in.flight_mode;
        packet1.aah_thr_pos = packet_in.aah_thr_pos;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PROSIGHT_OSD_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PROSIGHT_OSD_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_prosight_osd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_pack(system_id, component_id, &msg , packet1.altitude , packet1.msg_id , packet1.flags , packet1.flight_mode , packet1.aah_thr_pos );
	mavlink_msg_prosight_osd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.altitude , packet1.msg_id , packet1.flags , packet1.flight_mode , packet1.aah_thr_pos );
	mavlink_msg_prosight_osd_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_prosight_osd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_send(MAVLINK_COMM_1 , packet1.altitude , packet1.msg_id , packet1.flags , packet1.flight_mode , packet1.aah_thr_pos );
	mavlink_msg_prosight_osd_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_prosight_osd_debug(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
	mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PROSIGHT_OSD_DEBUG >= 256) {
        	return;
        }
#endif
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_prosight_osd_debug_t packet_in = {
		17235,17339,17443,17547
    };
	mavlink_prosight_osd_debug_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.debug_1 = packet_in.debug_1;
        packet1.debug_2 = packet_in.debug_2;
        packet1.debug_3 = packet_in.debug_3;
        packet1.debug_4 = packet_in.debug_4;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PROSIGHT_OSD_DEBUG_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PROSIGHT_OSD_DEBUG_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_debug_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_prosight_osd_debug_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_debug_pack(system_id, component_id, &msg , packet1.debug_1 , packet1.debug_2 , packet1.debug_3 , packet1.debug_4 );
	mavlink_msg_prosight_osd_debug_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_debug_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.debug_1 , packet1.debug_2 , packet1.debug_3 , packet1.debug_4 );
	mavlink_msg_prosight_osd_debug_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_prosight_osd_debug_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_prosight_osd_debug_send(MAVLINK_COMM_1 , packet1.debug_1 , packet1.debug_2 , packet1.debug_3 , packet1.debug_4 );
	mavlink_msg_prosight_osd_debug_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_prosight_osd(system_id, component_id, last_msg);
	mavlink_test_prosight_osd_debug(system_id, component_id, last_msg);
