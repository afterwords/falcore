...
#define M25P16_CS_GPIO_CLK_PERIPHERAL   RCC_APB2Periph_GPIOB
...
#define BLACKBOX
#define ENABLE_BLACKBOX_LOGGING_ON_SPIFLASH_BY_DEFAULT //verify that user flights are always recorded
