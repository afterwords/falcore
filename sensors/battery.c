...
uint16_t vbatSmooth = 0;            // battery voltage in 0.1V steps (smoothed even more)
...
static void updateBatteryVoltage(uint32_t vbatTimeDelta)
{
    ...
    static filterStatePt1_t vbatSmoothFilterState;
    ...
    vbatSmooth = filterApplyPt1(vbat, &vbatSmoothFilterState, 0.10f, vbatTimeDelta * 1e-6f);
}
