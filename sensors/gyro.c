...
static void performGyroscopeCalibration(uint8_t gyroMovementCalibrationThreshold)
{
    int8_t axis;
    static int32_t g[3];
...
void gyroUpdate(void)
{
    ...
    if (!isGyroCalibrationComplete()) {
        performGyroscopeCalibration(gyroConfig->gyroMovementCalibrationThreshold);
    }
