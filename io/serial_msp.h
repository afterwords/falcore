...
#define CONNEXFLIGHT_IDENTIFIER "FLCR"
#define BASEFLIGHT_IDENTIFIER "BAFL";

#define FLIGHT_CONTROLLER_IDENTIFIER_LENGTH 4
#define PRODUCT_ID_SPARE					11
#define CPU_UID_LENGTH_BYTES                12
static const char * const flightControllerIdentifier = CONNEXFLIGHT_IDENTIFIER; // 4 UPPER CASE alpha numeric characters that identify the flight controller.
...
//
// AMIMON: Specific messages for FMU, desktop tool and production tool
//
#define MSP_AMN_VERSION                 10
#define MSP_AMN_CALIBRATION_STATUS      11
#define MSP_AMN_SET_CALIBRATION         12
#define MSP_AMN_NEXT_CALIBRATION_STEP   13

#define MSP_AMN_GET_SIGNATURE           14
#define MSP_AMN_SET_SIGNATURE           15
#define MSP_AMN_GET_PRODUCT_SN          16
#define MSP_AMN_SET_PRODUCT_SN          17
#define MSP_AMN_BUZZER_MUTE	            18
...
typedef enum {
	MSP_HARDWARE_STATUS_NO_CALIBRATION              = 1 << 0,
	MSP_HARDWARE_STATUS_CONFIGURATION_MISMATCH      = 1 << 1,
	MSP_HARDWARE_STATUS_SIGNATURE_VALID             = 1 << 2,
	MSP_HARDWARE_STATUS_PROSIGHT_ACTIVATION_VALID   = 1 << 3,
	MSP_HARDWARE_STATUS_CO_CPU_IS_ALIVE             = 1 << 4,
	MSP_HARDWARE_STATUS_IMU_IS_ALIVE                = 1 << 5,
	MSP_HARDWARE_STATUS_SONAR_IS_ALIVE              = 1 << 6,
	MSP_HARDWARE_STATUS_BARO_IS_ALIVE               = 1 << 7,
	MSP_HARDWARE_STATUS_RC_SIGNAL_VALID             = 1 << 8,
} hwStatus_e;
