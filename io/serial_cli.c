...
static const char * const sensorHardwareNames[4][11] = {
    ...
    { "", "None", "BMP085", "BMP280", "MS5611", "MS5607", NULL },
    { "", "None", "HMC5883", "AK8975", "MAG3110", NULL }
};
#endif
...
const clivalue_t valueTable[] = {
...
#ifdef INCLUDE_FALCORE_CLI_PARAMS
    { "beeper_enable",              VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &masterConfig.enableBuzzer, .config.lookup = { TABLE_OFF_ON } },
#ifdef USE_PROSIGHT_IGNITION
    { "ignition_enable",            VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &masterConfig.enableProsightIgnition, .config.lookup = { TABLE_OFF_ON } },
#endif // USE_PROSIGHT_IGNITION
#endif // INCLUDE_FALCORE_CLI_PARAMS
    ...
    { "align_board_roll",           VAR_INT16  | MASTER_VALUE,  &masterConfig.calibration.boardAlignment.rollDeciDegrees, .config.minmax = { -1800,  3600 } },
    { "align_board_pitch",          VAR_INT16  | MASTER_VALUE,  &masterConfig.calibration.boardAlignment.pitchDeciDegrees, .config.minmax = { -1800,  3600 } },
    { "align_board_yaw",            VAR_INT16  | MASTER_VALUE,  &masterConfig.calibration.boardAlignment.yawDeciDegrees, .config.minmax = { -1800,  3600 } },
...
#ifdef INCLUDE_FALCORE_CLI_PARAMS
    { "max_inclination_fwd",        VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.max_angle_inclination[PITCH][1], .config.minmax = { 50,  900 } },
    { "max_inclination_back",       VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.max_angle_inclination[PITCH][0], .config.minmax = { 50,  900 } },
    { "max_inclination_right",      VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.max_angle_inclination[ROLL][1], .config.minmax = { 50,  900 } },
    { "max_inclination_left",       VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].pidProfile.max_angle_inclination[ROLL][0], .config.minmax = { 50,  900 } },
#endif
    ...
    { "yaw_p_limit",                VAR_UINT16 | CONTROL_RATE_VALUE, &masterConfig.controlRateProfiles[0].yaw_p_limit, .config.minmax = {YAW_P_LIMIT_MIN, YAW_P_LIMIT_MAX } },
    ...
    { "failsafe_procedure",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP,  &masterConfig.failsafeConfig.failsafe_procedure, .config.lookup = { TABLE_FAILSAFE_PROCEDURE } },
    ...
    { "baro_median_filter",         VAR_UINT8  | MASTER_VALUE | MODE_LOOKUP, &masterConfig.barometerConfig.apply_median_filter, .config.lookup = { TABLE_OFF_ON } },
...
#ifdef INCLUDE_FALCORE_CLI_PARAMS
    { "drone_mass",                 VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.droneMass, .config.minmax = { 0, 10000 } },
    { "extra_roll",            		VAR_UINT8  | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.extraRoll, .config.minmax = { 0, 255 } },
    { "stick_extra_roll",           VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.stickExtraRoll, .config.minmax = { 0, 100 } },
    { "dir_valid_vel",              VAR_UINT16 | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.dirModeValidVel, .config.minmax = { 0, 1000 } },
    { "dir_yaw_roll_ratio",         VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.yawToRollRatio, .config.minmax = { 0, 10 } },
	{ "dir_yaw_stick_factor",       VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].dirModeSettings.yawStickFactor, .config.minmax = {0.01, 1} },

    //{ "crash_detection_mode",       VAR_UINT8  | PROFILE_VALUE, &masterConfig.profile[0].crashDetectionSettings.mode, .config.minmax = { 0, CRASH_DETECT_MODES_COUNT-1 } },

    { "sonar_pitch_angle",          VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.sonar_pitch_angle, .config.minmax = { -30, 30 } },

    { "hover_throttle",             VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.hover_throttle, .config.minmax = { 1100, 1900 } },
    { "sonar_max_alt",              VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.sonar_max_alt, .config.minmax = { 10, 150 } },
    { "sonar_range",                VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.sonar_range, .config.minmax = { 10, 500 } },
    { "emerg_desc_timeout",         VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.emergency_descent_timeout, .config.minmax = { 0, 10 } },
    { "baro_max_alt",               VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.baro_max_alt, .config.minmax = { 500, 20000 } },

    { "alt_baro_z_w",               VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_baro_z_w, .config.minmax = { 0, 100 } },
    { "alt_baro_v_w",               VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_baro_v_w, .config.minmax = { 0, 100 } },
    { "alt_sonar_z_w",              VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_sonar_z_w, .config.minmax = { 0, 100 } },
    { "alt_sonar_v_w",              VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_sonar_v_w, .config.minmax = { 0, 100 } },
    { "baro_accz_bias_w",           VAR_FLOAT  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_baro_accz_bias_w, .config.minmax = { 0, 1 } },
    { "alt_hold_deadband",          VAR_UINT8  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.alt_hold_deadband, .config.minmax = { 1, 250 } },
    { "alt_max_roc_rod",            VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.max_roc_rod, .config.minmax = { 100, 1000 } },
    { "snl_max_rod",                VAR_INT16  | PROFILE_VALUE, &masterConfig.profile[0].altHoldSettings.max_snl_rod, .config.minmax = { 100, 1000 } },
#endif
    ...
    { "magzero_x",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.magZero.raw[X], .config.minmax = { -32768,  32767 } },
    { "magzero_y",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.magZero.raw[Y], .config.minmax = { -32768,  32767 } },
    { "magzero_z",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.magZero.raw[Z], .config.minmax = { -32768,  32767 } },

    { "acczero_x",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accZero.raw[X], .config.minmax = { -32768,  32767 } },
    { "acczero_y",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accZero.raw[Y], .config.minmax = { -32768,  32767 } },
    { "acczero_z",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accZero.raw[Z], .config.minmax = { -32768,  32767 } },

    { "accgain_x",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accGain.raw[X], .config.minmax = { 1,  8192 } },
    { "accgain_y",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accGain.raw[Y], .config.minmax = { 1,  8192 } },
    { "accgain_z",                  VAR_INT16  | MASTER_VALUE, &masterConfig.calibration.accGain.raw[Z], .config.minmax = { 1,  8192 } },
};
...
static void cliVersion(char *cmdline)
{
    ...
    cliPrintf("# ConnexFlight/%s %s %s / %s (%s)",
        targetName,
        FC_VERSION_STRING,
        buildDate,
        buildTime,
