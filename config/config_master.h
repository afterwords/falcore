...
// System-wide
typedef struct masterCalibration_t {
    uint32_t calibrationMagic;
...
typedef struct master_t {
    ...
    masterCalibration_t calibration;
    ...
    uint8_t gyroSync;                       // Enable interrupt based loo
    ...
    uint8_t enableProsightIgnition;
#endif
